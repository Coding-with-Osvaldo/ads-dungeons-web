...
export default function Game() {
  ...
  return (
    <>
      <body className="bodyCharacter">
        <div className="cardCharacter h-screen md:overflow-y-hidden">
          ...
          <div className="flex justify-between m-8 pt-8">
            <TextField
              ...
              className="inputTextUser w-70 pt-4 rounded-l-lg"
              id="filled-basic"
            ...
            <Button
              ...
              className="buttonConfig px-16 py-4 rounded-full text-lg "
              variant="contained">Jogar</Button>
          </div>
        </div>
      </body>
    </>
